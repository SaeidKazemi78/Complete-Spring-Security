...
export class CustomerSelectorComponent implements OnInit, OnChanges {
    ...
    @Input() mode: 'monthly-report' | 'other';
    @Input() customerTypeIds: any[];
    ...
    set value(val: any) {
        if (this.selectObject) {
            ...
            } else if (!this.multiSelect && (typeof val === 'number' || !isNaN(val))) {
    ...
    private onSuccess(data, headers) {
        ...
        if (this.totalItems === 1) {
            this.onSelect(this.customers[0], true);
        }
    }
