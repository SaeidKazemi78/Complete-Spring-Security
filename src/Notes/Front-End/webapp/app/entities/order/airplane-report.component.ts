...
@Component({
    ...
    templateUrl: './airplane-report.component.html'
})
export class AirplaneReportComponent implements OnInit/*, OnDestroy */ {
    currentAccount: any;
    error: any;
    success: any;
    ...
    async ngOnInit() {
        ...
        this.orderService.reportAirplane(this.orderId)
            .subscribe(res => {
                this.json = res.body;
                this.json.info['date'] = new DateJalaliPipe().transform(this.json.info['date']);
                const report = new Stimulsoft.Report.StiReport();
                report.loadFile('/content/mrt/RefuelCenterAirplane.V1.mrt');
