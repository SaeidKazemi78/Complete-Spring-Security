...
export class BankAccountService {
    ...
    private resourceUrl = 'niopdcaccounting/api/bank-accounts';
    ...
    query( personId: any, req?: any): Observable<HttpResponse<BankAccount[]>> {
        const options = createRequestOption(req);
        return this.http.get<BankAccount[]>(this.resourceUrl + '/person/' + personId  ,  { params: options, observe: 'response' })
    ...
    private convertItemFromServer(bankAccount: BankAccount): BankAccount {
        const copy: BankAccount = Object.assign(new BankAccount(), bankAccount);
        return copy;
    }
