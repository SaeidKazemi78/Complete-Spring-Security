...
export class BankAccountPopupService {
    ...
    open(component: Component, id?: number | any, personId?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.bankAccountService.find(id).subscribe(bankAccountResponse => {
