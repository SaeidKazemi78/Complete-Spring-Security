...
export class BankComponent implements OnInit, OnDestroy {
    ...
    search() {
        ...
        this.currentSearch = '';
        if (this.bank.name) {
            this.currentSearch += 'name$' + this.bank.name + '&';
        }
        if (this.bank.code) {
            this.currentSearch += 'code$' + this.bank.code + '&';
        }
    ...
    setBreadCrumb() {
        ...
        this.translateService.get('niopdcgatewayApp.bank.home.title').subscribe(title => {
