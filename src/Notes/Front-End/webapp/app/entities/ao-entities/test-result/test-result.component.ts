...
export class TestResultComponent implements OnInit, OnDestroy {
        ...
        for (const key of x) {
            ...
            if (value.length > 1) {
                if (value[0].indexOf('.') > 0) {
                    ...
                    this.testResult[value[0]] = Number(value[1]);
                } else {
    ...
    loadAll() {
        this.testResultService.query(this.Id, {
    ...
    clear() {
        ...
        this.router.navigate(['/' + this.Id + '/test-result'], {
            queryParams: {
                page: this.page,
    ...
    search() {
        this.page = 0;
        this.currentSearch = '';
        if (this.testResult.requestStatus) {
            this.currentSearch += 'requestStatus#RequestStatus.' + this.testResult.requestStatus + '&';
        }
        if (this.testResult.requestTestResultId) {
            this.currentSearch += 'requestTestResult.id☼' + this.testResult.requestTestResultId + '&';
        }
    ...
    ngOnInit() {
        ...
        this.requestTestResultService.query().subscribe(
            (res: HttpResponse<RequestTestResult[]>) => {
