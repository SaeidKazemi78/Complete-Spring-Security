...
@Component({
    ...
    templateUrl: './transfer-depot-to-dirty-dialog.component.html'
})
export class TransferDepotToDirtyDialogComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.dayDepotService.queryMainDayDepotIdAndOilTankType(this.mainDayDepotId, 'MAIN')
            .subscribe(value => {
                ...
                if (this.unitDayDepots && this.unitDayDepots.length > 0) {
                    ...
                    this.transferTypeService.queryByFromAndToOilTankType(this.OilTankType[this.OilTankType.MAIN], this.OilTankType[this.OilTankType.CONTAMINATED])
                        .subscribe(res => {
                            this.transfertypes = res.body;
                            if (this.transfertypes && this.transfertypes.length === 1) {
                                this.transfer.transferTypeId = this.transfertypes[0].id;
                                this.onChangeTransferType(this.transfer.transferTypeId);
                            }
...
export class TransferDepotToDirtyPopupComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.routeSub = this.route.params.subscribe(params => {
            this.transferPopupService
                .open(TransferDepotToDirtyDialogComponent as Component, null, null);
