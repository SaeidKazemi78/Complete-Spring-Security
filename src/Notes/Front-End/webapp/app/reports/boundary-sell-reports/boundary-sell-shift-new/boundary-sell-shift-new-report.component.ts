...
import {BoundarySellShiftReport, BoundarySellShiftRequest} from './boundary-sell-shift-new-report.model';
import {BoundarySellShiftNewReportService} from './boundary-sell-shift-new-report.service';
import {LocationService} from '../../../entities/location/index';
import {ProductService} from '../../../entities/product/index';
import {CustomerGroup} from '../../../entities/customer-type/index';
import {Principal} from 'app/shared';

@Component({
    selector: 'jhi-boundary-sell-report',
    templateUrl: './boundary-sell-shift-new-report.component.html'
})
export class BoundarySellShiftNewReportComponent implements OnInit, OnDestroy {
    ...
    orderTypeOptions = []
    constructor(
        private boundarySellShiftReportService: BoundarySellShiftNewReportService,
    ...
    private onSuccess(data) {
        ...
        this.state.take = this.boundarySellShiftReports.length;
        this.state.skip = 0;
