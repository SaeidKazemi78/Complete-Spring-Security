...
import {BoundarySellDiscountRequestDTO} from './boundary-sell-discount-report.model';
...
@Component({
    ...
    templateUrl: './boundary-sell-discount-report.component.html'
})
export class BoundaryDiscountSellReportComponent implements OnInit {
    ...
    constructor(
        ...
        private boundaryDiscountSellReportService: BoundaryDiscountSellReportService,
    ...
    setBreadCrumb() {
        ...
        this.translateService.get('niopdcgatewayApp.boundaryDiscountSell.home.title').subscribe(title => {
    ...
    report() {
        ...
        this.boundaryDiscountSellReportService.query(this.req)
            .subscribe(res => {
                ...
                report.loadFile('/content/mrt/boundaryDiscountSell.v12.mrt');
    ...
    downloadExcel() {
        this.boundaryDiscountSellReportService.downloacExcel(this.req).subscribe(response => {
            saveAs(response.body, 'download.xls');
        });
    }
}
