...
@Component({
    ...
    templateUrl: './metre-sheet-ao.component.html'
})
export class MetreSheetAoComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.metreSheetService.queryAo(this.req).subscribe(
    ...
    private onSuccess(data) {
        ...
        this.metreSheet.forEach(value => {
           value.productCode = `${value.productTitle}(${value.productCode})`
        });
